...
<main>
    <section class="relative h-[700px] z-0">
        <img src="<?= BASE_URL ?>images/jardinage-hero.webp" class="absolute inset-0 w-full h-full object-cover object-[center_65%] filter brightness-90" alt="un jardin propre avec une débrouissalleuse"/>
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="<?= BASE_URL ?>images/debroussaillage.webp" alt="Un homme débroussaille" class="w-full h-96 object-cover object-bottom">
                ...
                <!-- Service Tonte -->
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="<?= BASE_URL ?>images/tondeuse.webp" alt="Tonte de gazon" class="w-full h-96 object-cover">
                ...
                <!-- Service Élagage -->
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="<?= BASE_URL ?>images/elagage.webp" alt="Une homme coupe des branches" class="w-full h-96 object-cover">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer md:last:odd:col-span-2 md:last:odd:mx-auto md:last:odd:max-w-[48%]">
                    <img src="<?= BASE_URL ?>images/taille-haie.webp" alt="Un homme taille une haie" class="w-full h-96 object-cover">
