...
<main>
    <section class="relative h-[700px] z-0">
        <img src="/plaisirdaider/images/menage_hero.jpg" class="absolute inset-0 w-full h-full object-cover object-[center_65%] filter brightness-90" alt="un aspirateur"/>
    ...
    <article class="py-16 px-4 bg-gray-50">
        <div class="container mx-auto">
            <h2 class="text-3xl font-bold text-center mb-12">Nos Services d'Entretien Intérieur</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/cleaning.jpg" alt="Nettoyage général" class="w-full h-96 object-cover">
                    <div class="p-6">
                ...
                <!-- Service Repassage -->
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/repassage.jpg" alt="Repassage" class="w-full h-96 object-cover">
                    <div class="p-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/window-cleaning.webp" alt="Nettoyage des vitres" class="w-full h-96 object-cover">
                    <div class="p-6">
