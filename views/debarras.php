...
<main>
    <section class="relative h-[700px] z-0">
        <img src="/plaisirdaider/images/debarras-hero.webp" class="absolute inset-0 w-full h-full object-cover object-[center_65%] filter brightness-90" alt="Un camion rempli de déchets mobilier et végétaux"/>
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/debarras-mobilier.webp" alt="Un tas de mobilier devant une maison" class="w-full h-96 object-cover">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/debarras-gravier.webp" alt="un tas de gravier devant une maison" class="w-full h-96 object-cover">
                ...
                <!-- Tri et recyclage -->
                <div class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer">
                    <img src="/plaisirdaider/images/debarras-vegetaux.webp" alt="Un tas de végétaux dans un jardin" class="w-full h-96 object-cover">
